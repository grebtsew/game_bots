...
click_schedule = [
    ("0", 20, (start_x + 0 * box_size, start_y), 0, 15, 1, 0, True),
    ("1", 19, (start_x + 1 * box_size, start_y), 0, 5, 1, 1, True),
    
    ("2", 45, (start_x + 2 * box_size, start_y), 0, 10, 2, 2, True),
    ("3", 30, (start_x + 3 * box_size, start_y), 0, 5, 2, 2, True),
    ("4", 60, (start_x + 4 * box_size, start_y), 0, 5, 2, 2, True),

    #("7", 54, (start_x + 7 * box_size, start_y), 0, 5, 2, 0, True),
]
# -------------------- Functions --------------------
